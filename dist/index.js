        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    page = _a.sent();
                    // 跳转到指定页面
                    return [4 /*yield*/, page.goto("https://github.com/jiaozitang/puppeteerPdfDemo", {
                            // ${baseURL}/article/${id}
                ...
                case 3:
                    ...
                    // 加载所有懒加载资源
                    return [4 /*yield*/, tools_1.autoScroll(page)];
                case 4:
                    // 文章未对外开放，需登录后生成PDF
                    // 体验注入cookie流程需要内网的权限，这里不做演示了
                    // 我为什么能获取到cookie，是因为这个生成PDF的函数是在一个需登录态的接口中调用的，接口里能拿到cookie。
                    ...
                    ext = '.pdf';
                    key = tools_1.randomFilename('zjh', ext);
                    _path = path.resolve(rootDir + "/output", key);
                    console.log("key:", key);
